...
<div class="jumbotron jumbotron-fluid bg-dark text-white">
    <div class="container text-sm-center">
        <h1 class="display-2">Debate Paradise</h1>
        <p class="lead"><i>Sparkle between Great Minds.</i></p>
        <!--callout button-->
        <div class="btn-group mt-4" role="group" aria-label="Basic example">
            <button type="button" class="btn btn-light btn-lg d-block mx-auto" id="signup-button"><a
                        href="/NewPlace/NewWeb/php/signup.php">Sign Up</a></button>
            <button type="button" class="btn btn-light btn-lg d-block mx-auto" id="loginbutton"><a
                        href="/NewPlace/NewWeb/php/login.php">Login</a></button>
        </div>
